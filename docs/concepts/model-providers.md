...
SiliconFlow provides OpenAI-compatible chat completions via a custom base URL.

- Provider: `siliconflow`
- Auth: `SILICONFLOW_API_KEY`
- Example model: `siliconflow/Pro/moonshotai/Kimi-K2.5`
...
See [/providers/siliconflow](/providers/siliconflow) for more details.

...
export type GatewayWebchatNotifyFeishuConfig = {
  /** Enable Feishu webhook forwarding for webchat replies. */
  enabled?: boolean;
  /** Feishu bot webhook URL. */
  webhook?: string;
  /** Optional Feishu webhook secret (for signed webhooks). */
  secret?: string;
  /** Optional keyword prefix for Feishu keyword-validated bots. */
  keyword?: string;
};

export type GatewayWebchatNotifyConfig = {
  /** Enable webchat forwarding (default: false). */
  enabled?: boolean;
  /** Feishu webhook configuration. */
  feishu?: GatewayWebchatNotifyFeishuConfig;
};

export type GatewayWebchatConfig = {
  /** External notifications for webchat responses. */
  notify?: GatewayWebchatNotifyConfig;
};

...
const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.webchat.notify.enabled": "Webchat Forwarding Enabled",
  "gateway.webchat.notify.feishu.enabled": "Webchat Feishu Forwarding",
  "gateway.webchat.notify.feishu.webhook": "Webchat Feishu Webhook",
  "gateway.webchat.notify.feishu.secret": "Webchat Feishu Webhook Secret",
  "gateway.webchat.notify.feishu.keyword": "Webchat Feishu Keyword Prefix",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "gateway.webchat.notify.enabled":
    "Forward final webchat replies to external channels (default: false).",
  "gateway.webchat.notify.feishu.enabled": "Enable forwarding to Feishu bot webhook.",
  "gateway.webchat.notify.feishu.webhook": "Feishu bot webhook URL for webchat forwarding.",
  "gateway.webchat.notify.feishu.secret":
    "Feishu bot secret for signed webhook requests (optional).",
  "gateway.webchat.notify.feishu.keyword":
    "Optional keyword prefix for Feishu keyword-validated bots.",

...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    description: [
      ...
      "If a page requires login, ask the user to sign in manually in the browser first, then continue. Do not attempt automated credential entry unless explicitly provided.",
      "If content is long or paginated, scroll or move to the next page and re-snapshot until the needed content is captured.",
